...
histo_height = 0
histo_width = 0
def make_legend(X1,Y2, nentries):
    width = 0.3
    X2 = X1 + width
...
def set_style(width,height,ratio):
    global marg_top,marg_bot,marg_left,marg_right,histo_height,histo_width
    ...
    ##g Margins:
    histo_height = height - marg_bot - marg_top
    histo_width = histo_height/ratio
    marg_right = width-marg_left - histo_width
    # print histo_width,histo_height
    # raw_input ('%s = %s + %s + %s'%(width, marg_left, histo_width, marg_right))
    ROOT.gStyle.SetPadTopMargin(marg_top/height);
    ROOT.gStyle.SetPadBottomMargin(marg_bot/height);
    ROOT.gStyle.SetPadLeftMargin(marg_left/width);
    ROOT.gStyle.SetPadRightMargin(marg_right/width);
